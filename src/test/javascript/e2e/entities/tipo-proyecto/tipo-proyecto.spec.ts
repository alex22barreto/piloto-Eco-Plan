...
describe('TipoProyecto e2e test', () => {
  ...
  it('should create and save TipoProyectos', async () => {
    ...
    await promise.all([
      tipoProyectoUpdatePage.setIdTipoProyectoInput('5'),
      tipoProyectoUpdatePage.setNombreTipoProyectoInput('nombreTipoProyecto')
    ]);

    expect(await tipoProyectoUpdatePage.getIdTipoProyectoInput()).to.eq('5', 'Expected idTipoProyecto value to be equals to 5');
