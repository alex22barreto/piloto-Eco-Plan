...
export class TipoProyectoUpdatePage {
  ...
  idTipoProyectoInput = element(by.id('field_idTipoProyecto'));
  ...
  async setIdTipoProyectoInput(idTipoProyecto: string): Promise<void> {
    await this.idTipoProyectoInput.sendKeys(idTipoProyecto);
  }

  async getIdTipoProyectoInput(): Promise<string> {
    return await this.idTipoProyectoInput.getAttribute('value');
  }
