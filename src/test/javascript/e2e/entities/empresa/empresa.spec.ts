...
describe('Empresa e2e test', () => {
  ...
  it('should create and save Empresas', async () => {
    ...
    await promise.all([
      ...
      empresaUpdatePage.setPersonaContactoInput('5'),
      empresaUpdatePage.personaContactoSelectLastOption()
    ]);
    ...
    expect(await empresaUpdatePage.getPersonaContactoInput()).to.eq('5', 'Expected personaContacto value to be equals to 5');
