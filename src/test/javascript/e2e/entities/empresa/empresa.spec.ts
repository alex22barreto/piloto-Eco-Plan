...
describe('Empresa e2e test', () => {
  ...
  it('should create and save Empresas', async () => {
    ...
    await promise.all([
      ...
      empresaUpdatePage.setIdentificacionEmpresaInput('identificacionEmpresa'),
    ...
    expect(await empresaUpdatePage.getIdentificacionEmpresaInput()).to.eq(
      'identificacionEmpresa',
      'Expected IdentificacionEmpresa value to be equals to identificacionEmpresa'
    );
