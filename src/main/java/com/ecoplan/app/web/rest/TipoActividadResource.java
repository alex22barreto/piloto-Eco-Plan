...
public class TipoActividadResource {
    ...
    public ResponseEntity<TipoActividad> createTipoActividad(@Valid @RequestBody TipoActividad tipoActividad) throws URISyntaxException {
    ...
    public ResponseEntity<TipoActividad> updateTipoActividad(@Valid @RequestBody TipoActividad tipoActividad) throws URISyntaxException {
