...
import com.ecoplan.app.domain.Proyecto;
import com.ecoplan.app.repository.ProyectoRepository;
...
/**
 * REST controller for managing {@link com.ecoplan.app.domain.Proyecto}.
 */
@RestController
@RequestMapping("/api")
@Transactional
